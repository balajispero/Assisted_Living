...
--
-- Host: localhost:3306
-- Generation Time: May 20, 2024 at 01:55 PM
...
CREATE TABLE `physio_evaluation` (
  ...
  `mobility_notappl_assist8` text,
  `mobility_notappl_evaldate` text,
  `mobility_notappl_rolling` text,
  `mobility_notappl_supine` varchar(5) DEFAULT NULL,
  `mobility_notappl_stand` text,
  ...
  `transfer_notappl_assist8` text,
  `transfer_notappl_evaldate` text,
  `ptn_pain_bodypart` text,
