        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    <h1>Add Interventions</h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url()?>app/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Admin</a></li>
                        <li><a href="#">Medicine Management</a></li>
                        <li><a href="<?php echo base_url()?>app/drug_name">Intervention Master</a></li>
                        <li class="active">Add Intervention</li>
                    </ol>
                </section>
                    	 ...
                    	 <div class="box">
                        	...
                        	<div class="box-body table-responsive">
                            	<form role="form" method="post" action="<?php echo base_url()?>app/drug_name/save" onSubmit="return confirm('Are you sure you want to save?');">
                                        ...
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Intervention Name</label>
                                            <input class="form-control input-sm" name="drug_name" id="drug_name" type="text" placeholder="Description" style="width: 350px;">
                                        </div>
                                        ...
                                        <!-- <div class="form-group">
                                            ...
                                            <select name="uom" id="uom" class="form-control input-sm" style="width: 250px;" required>
																...
																foreach($uom as $uom){
																?>
                                                            	<option value="<?php echo $uom->param_id;?>"><?php echo $uom->cValue;?></option>
                                                                <?php }?>
                                                            </select>
                                        </div>
