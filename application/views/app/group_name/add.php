            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Add Group Name</li>
                    </ol>
                </section>
                 	...
                 	<div class="col-md-12">
                    	 ...
                    	 <div class="box">
                        	...
                        	<div class="box-body table-responsive">
                            	<form role="form" method="post" action="<?php echo base_url()?>app/bill_group_name/save" onSubmit="return confirm('Are you sure you want to save?');">
                                
                                		<?php echo validation_errors(); ?>   
                                
                                		<div class="form-group">
                                            <label for="exampleInputEmail1">Group Name</label>
                                            <input class="form-control input-sm" name="group_name" id="group_name" type="text" placeholder="Group Name" style="width: 250px;" required>
                                        </div>
