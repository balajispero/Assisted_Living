                                    ...
                                    <div class="nav-tabs-custom">
                                        ...
                                        <div class="tab-content">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        ...
                                                        <div class="form-group input-box">
                                                            ...
                                                            <?php echo form_input('phone', set_value('phone'), 'id="phone" class="form-control numberonly" maxlength="10"  placeholder="Phone No (Work)"'); ?>
                                                        </div>
                                                        <div class="form-group input-box">
                                            ...
                                            <div class="tab-pane" id="tab_4">
                                                <div class="row">
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="form-group input-box ">
                                                            <label>KCO:</label>
                                                            <textarea class="form-control" name="ptn_kco" id="ptn_kco"></textarea>
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>Chief Complaint:</label>
                                                            <textarea class="form-control" name="ptn_chf_comp" id="ptn_chf_comp"></textarea>
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>Family History</label>
                                                            <textarea class="form-control" name="ptn_fam_his" id="ptn_fam_his"></textarea>
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>Past History(Surgical/Medical):</label>
                                                            <textarea class="form-control" name="ptn_past_his" id="ptn_past_his"></textarea>
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>Pulse:</label>
                                                            <input class="form-control" name="ptn_pulse" placeholder="/min" id="ptn_pulse" type="number">
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="form-group input-box">
                                                            ...
                                                            <textarea class="form-control" name="ptn_foodin" id="ptn_foodin"></textarea>
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>Urine/Motion:</label>
                                                            <textarea class="form-control" name="ptn_um" id="ptn_um"></textarea>
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>P/A:</label>
                                                            <textarea class="form-control" name="ptn_pa" id="ptn_pa"></textarea>
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>R/S:</label>
                                                            <textarea class="form-control" name="ptn_rs" id="ptn_rs"></textarea>
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>Temp:</label>
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="form-group input-box">
                                                            <label>CVS:</label>
                                                            <input class="form-control" name="ptn_cvs" id="ptn_cvs">
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>B.P:</label>
                                                            <input class="form-control" name="ptn_bp" id="ptn_bp" type="number" placeholder="mmhg" value="">
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>CNS:</label>
                                                            <input class="form-control" name="ptn_cns" id="ptn_cns">
                                                        </div>
                                                        <div class="form-group input-box">
                                                            <label>SPO2:</label>
                                                            <input class="form-control" name="ptn_spo2" id="ptn_spo2" placeholder="%" type="number" value="">
                                                        </div>
                                            ...
                                            <div class="tab-pane" id="tab_5">
                                                <table cellpadding="3" cellspacing="3" width="100%">
                                                    <tr>
                                                        <td width="30%"><button type="button" class="btn btn-outline-primary hvr-shutter-in-vertical" required name="add" id="add">Add Medicine</button><br><br>
