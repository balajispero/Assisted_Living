...
<body>
<?php echo $message;?>
<?php echo form_open_multipart(base_url().'app/patient/addAssesForm'); ?>
	<input type="hidden" name="patient_no" value="<?php echo $patient_no;?>">
    <fieldset>
    	<legend> UPLOAD ASSESMENT FILE </legend>
        ...
        <tr>
        	<td colspan="2">
            <a href="<?php echo base_url()?>app/patient/attachment_form/<?php echo $patient_no;?>" class="btn btn-sm btn-default">Cancel</a>
