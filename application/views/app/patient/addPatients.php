                           ...
                           <div class="tab-pane" id="tab_2">
                            ...
                            <div class="tab-pane" id="tab_4">
                               ...
                               <tr>
                                   ...
                                   <td width="88%"><input class="form-control input-sm" name="ptn_temp" style="width: 250px;" id="ptn_temp" type="number" placeholder="Fahrenheit(¡ÆF)" style="width: 100px;"   value=""></td>
