                                ...
                                <div class="col-lg-6">
                                                <table cellpadding="3" cellspacing="3" width="100%">
                                                    ...
                                                    <tr>
                                                        <td>Name<font color="#FF0000"></font></td>
                                                        <td>
                                                            <?php echo form_input('rel_name2',set_value('rel_name2',$patientInfo->rel_name2),' class="form-control input-sm alphaonly" placeholder="Name" style="width: 250px;"');?> 
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>Relation With<font color="#FF0000"></font></td>
                                            ...
                                            <div class="box-footer clearfix">
                                            <button class="btn btn-primary" name="btnSubmit" id="btnSubmit" type="submit" value="save"><i class="fa fa-save"></i> Save</button>
                                            <a href="<?php echo base_url();?>app/patient" class="btn btn-default">Cancel</a>
