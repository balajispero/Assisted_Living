            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">Complain Master</li>
                    </ol>
                </section>
                ...
                <section class="content">
                 ...
                 <div class="row">
                 	<div class="col-md-12">
                    	 ...
                    	 <div class="box">
                         		<form class="form-search" method="post" action="<?php echo base_url();?>app/complain">
                         		<div class="box-header">
                                    <h3 class="box-title"><a href="<?php echo base_url();?>app/complain/add" class="btn btn-outline-primary hvr-shutter-in-vertical"><i class="fa fa-plus"></i> Add New</a></h3>
