...
(adsbygoogle = window.adsbygoogle || []).push({});
    ...
    <body class="skin-blue">
                                    ...
                                    <div class="tab-content">
                                    	<div class="tab-pane active" id="tab_1">
                                           ...
                                           <tr>
                                                ...
                                                <td>
                                                <!--<a href="<?php echo base_url()?>app/nurse_module/delete_vital/<?php echo $rows->vital_id?>/<?php echo $getOPDPatient->IO_ID?>/<?php echo $getOPDPatient->patient_no?>" onClick="return confirm('Are you sure you want to remove?');">Remove</a>-->
        ...
        <!-- Modal -->
                            <form method="post" action="<?php echo base_url()?>app/nurse_module/save_vitalSign" onSubmit="return confirm('Are you sure you want to save?');">
