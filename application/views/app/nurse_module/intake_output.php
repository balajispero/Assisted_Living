                            ...
                            <div class="modal fade" id="myModal2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <tr>
                                            <td>Stool</td>
                                            <td><input type="text" name="no_stool" placeholder="No. of Stool" class="form-control input-sm" style="width: 100%;"></td>
                                        </tr>
                                        <tr>
                                            <td>Remark</td>
                                            <td><input type="text" name="remark" placeholder="Remark" class="form-control input-sm" style="width: 100%;"></td>
                                        </tr>
                                        <!--<tr>
                                        	<td>Feaces(ml)</td>
