...
(adsbygoogle = window.adsbygoogle || []).push({});
    ...
    <body class="skin-blue">
                     ...
                     <div class="col-md-9"> 
                                <div class="nav-tabs-custom">
                                	<ul class="nav nav-tabs">
                                		<li class="active"><a href="#tab_1" data-toggle="tab">Drug Chart</a></li>
                                    ...
                                    <div class="tab-content">
                                    	<div class="tab-pane active" id="tab_1">
                                           ...
                                           <a href="#" class="btn btn-primary" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Add Drug</a>
                                           <?php //}}?>
                                           <a href="<?php echo base_url()?>app/ipd_print/print_drug_chart/<?php echo $getOPDPatient->IO_ID;?>/<?php echo $getOPDPatient->patient_no;?>" class="btn btn-default" target="_blank"><i class="fa fa-print"></i> Print</a>
                                           ...
                                           <tr>
                                                ...
                                                <?php //if($this->session->userdata('emr_viewing') == ""){?>	
                                                <?php //if($getOPDPatient->nStatus == "Pending"){?>
                                                <a href="<?php echo base_url()?>app/nurse_module/delete_drug_chart/<?php echo $rows->drug_chart_id?>/<?php echo $getOPDPatient->IO_ID?>/<?php echo $getOPDPatient->patient_no?>" onClick="return confirm('Are you sure you want to remove?');">Remove</a>
                                                <?php //}}?>
                                                </td>
                                           </tr>
                                           <?php }?> 
        ...
        <!-- END BDAY -->
							...
							<!-- Modal -->
                            <form method="post" action="<?php echo base_url()?>app/nurse_module/save_drug_chart" onSubmit="return confirm('Are you sure you want to save?');">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Drug </h4>
                                        </div>
...
xmlhttp.send();
                                        ...
                                        <tr>
                                        	<td>Drug</td>
                                            <td><input type="text" name="drug" placeholder="Drug" class="form-control input-sm" style="width: 100%;" required></td>
                                        </tr>
                                        <!--<tr>
                                            <td>Morning</td>
                                            <td><input type="text" name="morning" class="form-control input-sm" style="width: 100%;" required></td>
                                        </tr>
                                        <tr>
                                            <td>Afternoon</td>
                                            <td><input type="text" name="afternoon" placeholder="Enter 0 or 1" class="form-control input-sm" style="width: 100%;" required></td>
                                        </tr>
                                        <tr>
                                            <td>Night</td>
                                            <td><input type="text" name="night" placeholder="Enter 0 or 1" class="form-control input-sm" style="width: 100%;" required></td>
                                        </tr>-->
                                        <tr>
                                            <td>Morning</td>
                                            <td>
                                            <select name="morning" class="form-control input-sm" style="width: 100%;" required>
                                        ...
                                        <tr>
                                            <td>Afternoon</td>
                                            <td>
                                            <select name="afternoon" class="form-control input-sm" style="width: 100%;" required>
                                                                <option value="0">0</option>
                                                                <option value="1">1</option>
                                                            </select>
                                            </td>
                                        ...
                                        <tr>
                                            <td>Night</td>
                                            <td>
                                            <select name="night" class="form-control input-sm" style="width: 100%;" required>
                                                                <option value="0">0</option>
                                                                <option value="1">1</option>
                                                            </select>
                                            </td>
