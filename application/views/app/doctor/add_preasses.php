...
<head><meta charset="euc-kr">
    ...
    <body class="skin-blue">
                                                 ...
                                                 <div class="tab-pane active" id="tab_1">
                                                    ...
                                                    <?php echo $message;?>
                                                       ...
                                                       <option value="Unitarian">Unitarian</option>
                                                                ...
                                                                <hr style="border-top: 2px solid rgb(128, 128, 128);"/>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group wrapper-class" >
                                                                            ...
                                                                            <select class="form-control" onchange="anganwaditype()" name="type_category" id="type_category">
        ...
        <tr>
          <td>You have fallen in the past year?<input type="hidden" name="past_year_qtn" class="form-control" value="you have fallen in the past year?"></td><td><!-- <input type="text" name="past_year" class="form-control"> --><input type="radio" class="chkradio form-control past_year" name="past_year" value="2" onchange="fallRiskAssesFunc()">Yes &nbsp;
    <input type="radio" name="past_year" class="chkradio form-control past_year" value="0" onchange="fallRiskAssesFunc()">No</td>
        </tr>
        <tr>
          <td>Do you use or have been advised to use a stick or walker to move around safely?<input type="hidden" name="use_stick_qtn" class="form-control" value="Do you use or have been advised to use a stick or walker to move around safely?"></td><td><!-- <input type="text" name="use_stick" class="form-control"> --><input type="radio" class="form-control" name="use_stick" value="2" checked>Yes &nbsp;
    <input type="radio" name="use_stick" class="form-control" value="0">No</td>
        </tr>
        <tr>
          <td>Do you feel unsteady while you are walking<input type="hidden" name="feel_stable_qtn" class="form-control" value="Do you feel unsteady while you are walking"></td><td><!-- <input type="text" name="feel_stable" class="form-control"> --><input type="radio" class="form-control" name="feel_stable" value="1" checked>Yes &nbsp;
    <input type="radio" name="feel_stable" class="form-control" value="0">No</td>
        </tr>
        <tr>
          <td>Do you steady yourself by holding onto furniture while walking at home?<input type="hidden" name="steady_holding_qtn" class="form-control" value="Do you steady yourself by holding onto furniture while walking at home?"></td><td><!-- <input type="text" name="steady_holding" class="form-control"> --><input type="radio" class="form-control" name="steady_holding" value="1" checked>Yes &nbsp;
    <input type="radio" name="steady_holding" class="form-control" value="0">No</td>
        </tr>

        <tr>
          <td>You are worried about falling?<input type="hidden" name="worry_fall_qtn" class="form-control" value="You are worried about falling?"></td><td><!-- <input type="text" name="worry_fall" class="form-control"> --><input type="radio" class="form-control" name="worry_fall" value="1" checked>Yes &nbsp;
    <input type="radio" name="worry_fall" class="form-control" value="0">No</td>
        </tr>
        <tr>
          <td>Do You need to push with your hands to stand up from a chair?<input type="hidden" name="from_chair_qtn" class="form-control" value="Do You need to push with your hands to stand up from a chair?"></td><td><!-- <input type="text" name="from_chair" class="form-control"> --><input type="radio" class="form-control" name="from_chair" value="1" checked>Yes &nbsp;
    <input type="radio" name="from_chair" class="form-control" value="0">No</td>
        </tr>
        <tr>
          <td>Do You have some trouble to stepping up onto a curb?<input type="hidden" name="curb_qtn" class="form-control" value="Do You have some trouble to stepping up onto a curb?"></td><td><!-- <input type="text" name="curb" class="form-control"> --><input type="radio" class="form-control" name="curb" value="1" checked>Yes &nbsp;
    <input type="radio" name="curb" class="form-control" value="0">No</td>
        </tr>
        <tr>
          <td>Do you often have to rush to the toilet?<input type="hidden" name="toilet_rush_qtn" class="form-control" value="Do you often have to rush to the toilet?"></td><td><!-- <input type="text" name="toilet_rush" class="form-control"> --><input type="radio" class="form-control" name="toilet_rush" value="1" checked>Yes &nbsp;
    <input type="radio" name="toilet_rush" class="form-control" value="0">No</td>
        </tr>

        <tr>
          <td>Have lost some feeling in your feet?<input type="hidden" name="lost_feet_qtn" class="form-control" value="Have lost some feeling in your feet?"></td><td><!-- <input type="text" name="lost_feet" class="form-control"> --><input type="radio" class="form-control" name="lost_feet" value="1" checked>Yes &nbsp;
    <input type="radio" name="lost_feet" class="form-control" value="0">No</td>
        </tr>
        <tr>
          <td>Do you take medicine that sometimes make you feel light- headed or more tired than usual?<input type="hidden" name="light_headed_qtn" class="form-control" value="Do you take medicine that sometimes make you feel light- headed or more tired than usual?"></td><td><!-- <input type="text" name="light_headed" class="form-control"> --><input type="radio" class="form-control" name="light_headed" value="1" checked>Yes &nbsp;
    <input type="radio" name="light_headed" class="form-control" value="0">No</td>
        </tr>
        <tr>
          <td>Do you take medicine to help you sleep or improve your mood?<input type="hidden" name="take_medicine_qtn" class="form-control" value="Do you take medicine to help you sleep or improve your mood?"></td><td><!-- <input type="text" name="take_medicine" class="form-control"> --><input type="radio" class="form-control" name="take_medicine" value="1" checked>Yes &nbsp;
    <input type="radio" name="take_medicine" class="form-control" value="0">No</td>
        </tr>
        <tr>
          <td>I often feel sad or depressed<input type="hidden" name="feel_sad_qtn" class="form-control" value="I often feel sad or depressed"></td><td><!-- <input type="text" name="feel_sad" class="form-control"> --><input type="radio" class="form-control" name="feel_sad" value="1" checked>Yes &nbsp;
    <input type="radio" name="feel_sad" class="form-control" value="0">No</td>
        </tr>
        <tr>
                                                                 ...
                                                                 <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group wrapper-class" >
                                                                            ...
                                                                            <textarea name="preasses_doctor_observation" class="form-control"></textarea>
                                                                            <span class="text-danger error-text type_category_err"></span>
                                                                        </div><!-- /.form-group wrapper-class -->
                                                                    </div><!-- /.col-md-3 -->
                                                                    <div class="col-md-3">
                                                                        <div class="form-group wrapper-class" >
                                                                            ...
                                                                            <textarea name="preasses_doctor_recommendation" class="form-control"></textarea>
                                                                            <span class="text-danger error-text type_category_err"></span>
                                                                        </div><!-- /.form-group wrapper-class -->
                                                                    </div><!-- /.col-md-3 -->
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-3">
                                                                        <div class="form-group wrapper-class" >
                                                                            ...
                                                                            <input type="radio" name="ptn_eligible" class="form-control" value="No">No
                                                                            <span class="text-danger error-text type_category_err"></span>
                                                                        </div><!-- /.form-group wrapper-class -->
                                                                    </div><!-- /.col-md-3 -->
                                                                </div><!-- / row -->
...
<!-- END BDAY -->
        <script>
            const radioButtons = document.querySelectorAll('input[class="chkradio"]');
        //const textBox = document.getElementById('textBox');
console.log("dsdnsd");
        // Add change event listeners to radio buttons
        radioButtons.forEach(radioButton => {
            radioButton.addEventListener('change', function () {
                // Update the text box value when a radio button is changed
        ...
        $('input').on('change', function() {
            alert($('input[name="past_year"]:checked', '#Demo').val());
        });
    });*/
            /*$(function () {
    $('input[name="past_year"]:radio').change(function () {
        alert($("input[name='past_year']:checked").val());
    });
});
$(".past_year") // select the radio by its id
    .change(function(){ // bind a function to the change event
        if( $(this).is(":checked") ){ // check if the radio is checked
            ...
            // Get the radio buttons and text box element
        /*const radioButtons = document.querySelectorAll('input[class="chgrad"]');
        const textBox = document.getElementById('textBox');
        ...
        radioButtons.forEach(radioButton => {
            radioButton.addEventListener('change', function () {
                // Update the text box value when a radio button is changed
                textBox.value = this.value;
                //var riskAssesTotal1=Number($(".past_year").val());
                //$("#fall_total_score").val(riskAssesTotal1);
            });
        });*/
          ...
          /*********************Start Calculate Age**********************/
          function fallRiskAssesFunc() {
            var riskAssesTotal;
            console.log("ffdf")
            var checkj=$('input[name="past_year"]:checked').val();
            console.log(checkj);
            riskAssesTotal=Number($(".past_year").val());
            /*grandTotal = Number($("#bowels_score").val()) + Number($("#bladder_score").val())+ Number($("#toilet_score").val())+ Number($("#bathing_score").val())+ Number($("#grooming_score").val())+ Number($("#dressing_score").val())+ Number($("#feeding_score").val())+ Number($("#transfer_score").val())+ Number($("#mobility_score").val())+ Number($("#stairs_score").val());*/
            $("#fall_total_score").val(riskAssesTotal);
          }
          /*********************End Calculate Age**********************/
        </script>
<script>
