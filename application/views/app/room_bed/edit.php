    ...
    <body class="skin-blue">
                        	...
                        	<div class="box-body table-responsive">
                                ...
                                <input type="hidden" name="id" value="<?php echo $bed->room_bed_id?>">
                                		...
                                		<div class="form-group">
                                            ...
                                            <input class="form-control input-sm numberonly" name="bed_name" id="bed_name" type="text" value="<?php echo $bed->bed_name?>" placeholder="Bed No/Name" style="width: 250px;" required>
                                        </div>
        ...
        <script>
            $(document).ready(function() {
                // Remove char from room_name input value
                
            var bedName = $('#bed_name').val();
            $('#bed_name').val(bedName.replace(/\D/g, ''));
            });
