                        	...
                        	<div class="box-body table-responsive">
                                ...
                                <input type="hidden" name="id" id="id" value="<?php echo $pages->page_id;?>">
                                		...
                                		<div class="form-group">
                                            ...
                                            <input class="form-control input-sm" name="page_module" id="page_module" type="text" placeholder="Page Module" style="width: 350px;" required value="<?php echo $pages->page_module;?>"> 
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Page Name</label>
                                            <input class="form-control input-sm" name="page_name" id="page_name" type="text" placeholder="Page Name" style="width: 350px;" required value="<?php echo $pages->page_name;?>">
                                        </div>
                                        
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">Page Link</label>
                                            <input class="form-control input-sm" name="page_link" id="page_link" type="text" placeholder="Page Link" style="width: 350px;" required value="<?php echo $pages->page_link;?>">
                                        </div>
