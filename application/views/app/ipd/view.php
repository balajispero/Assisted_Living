                            ...
                            <div class="box-footer clearfix">
                            	<div style="margin-top: 15px;">
                                 <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <!-- <li><a href="<?php echo base_url()?>app/ipd/intake_output1/<?php echo $getOPDPatient->IO_ID;?>/<?php echo $getOPDPatient->patient_no;?>"> Input/Output Record</a></li> -->
                                    	...
                                    	<div class="tab-pane active" id="tab_1">
                                            ...
                                            <tr>
                                                ...
                                                <select name="ptn_type" class="form-control col-md-3">
                                                                ...
                                                                <?php
                                                                foreach($departmentList as $departmentList1){
                                                                if($getOPDPatient->patient_type == $departmentList1->patient_type){
                                                                    $selected = "selected='selected'";
                                                                }else{
                                                                    $selected = "";
                                                                }
                                                                ?>
                                                                <option value="<?php echo $departmentList1->patient_type;?>" <?php echo $selected;?>><?php echo $departmentList1->patient_type;?></option>
                                                                <?php }?>
                                                            </select>&nbsp;
                                                            <?php if($getOPDPatient->nStatus == "Pending"){?>
                                                             <button class="btn btn-primary hvr-shutter-in-vertical" name="btnSubmit" id="btnSubmit" type="submit">Update</button>
                                                         <?php } ?>
