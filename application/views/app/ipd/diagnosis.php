                                ...
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-content">
                                    	<div class="tab-pane active" id="tab_1">
                                            ...
                                            <a href="#" class="btn btn-outline-primary hvr-shutter-in-vertical" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Add Diagnosis</a>
                                          <?php } ?>
                                           ...
                                           <tr>
                                                ...
                                                <?php if($this->session->userdata('emr_viewing') == ""){?>	
                                                <?php if($getOPDPatient->nStatus == "Pending"){?>
                                                <!--<a href="<?php echo base_url()?>app/ipd/delete_diagnos/<?php echo $diagnosisList4->iop_diag_id?>/<?php echo $getOPDPatient->IO_ID?>/<?php echo $getOPDPatient->patient_no?>" onClick="return confirm('Are you sure you want to remove?');">Remove</a>-->
                                                <?php }}?>
                                                </td>
                                           </tr>
                                           <?php }?>
