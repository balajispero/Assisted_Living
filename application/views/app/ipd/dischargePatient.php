                        	...
                        	<div class="box-body table-responsive">
                                            ...
                                            <div class="tab-content">
                                            	<div class="tab-pane active" id="tab_1">
                                                    ...
                                                    <tr>
                                                     ...
                                                     <tr>
                                                    	<td>Member's Name </td>
                                                        <td>
                                                        <?php echo form_input('middlename',set_value('middlename',$patientInfo->middlename),'id="middlename" class="form-control input-sm" placeholder="Last Name" style="width: 250px;" required');?>
                                                        </td>
                                                    </tr>
                                                    <!-- <tr>
                                                    ...
                                                    <tr>
                                                        <td>Discharge Report<font color="#FF0000"></font></td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>Discharge Date <font color="#FF0000"></font></td>
                                                        <td>
                                                        <input class="birthday form-control input-sm" name="discharge_date" type="date" value="" placeholder="Discharge Date" style="width:150px;">
                                                ...
                                                <div class="tab-pane" id="tab_2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td width="86%">
                                                        <?php echo form_input('phone_relative',set_value('phone_relative',$patientInfo->phone_no_office),'id="phone_office" class="form-control input-sm" placeholder="Phone No (Office)" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    	<td width="14%">Phone No (Home)</td>
                                                        <td width="86%">
                                                        <?php echo form_input('phone_home',set_value('phone_home',$patientInfo->phone_no),'id="phone_office" class="form-control input-sm" placeholder="Phone No (Office)" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    	<td width="14%">Phone No (Mobile)</td>
                                                        <td width="86%"> 
                                                        <?php echo form_input('phone_mobi',set_value('phone_mobi',$patientInfo->mobile_no),'id="phone_office" class="form-control input-sm" placeholder="Phone No (Office)" style="width: 250px;"');?>
                                                        </td>
                                                    </tr>
                                ...
                                <div class="col-lg-6">
                                                <table cellpadding="3" cellspacing="3" width="100%">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-5 text-center"><h3>1]Relative Contact</h3>
                                                        </div>
                                                    </div>
                                                    <tr>
                                ...
                                <div class="col-lg-6">
                                                <table cellpadding="3" cellspacing="3" width="100%">
                                                    ...
                                                    <div class="form-group row">
                                                        <div class="col-sm-5 text-center"><h3>2]Relative Contact</h3>
                                                        </div>
                                                    </div>
                                                    <tr>
                                                        <td>Relation With<font color="#FF0000"></font></td>
                                                ...
                                                <table cellpadding="3" cellspacing="3" width="100%">
                                                    <tr>
                                                        <td width="20%"><button type="button" class="btn btn-primary bg_color" name="add" id="add">Add Medicine</button><br><br>
