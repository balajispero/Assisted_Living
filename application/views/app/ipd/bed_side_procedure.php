                                    ...
                                    <div class="tab-content">
                                    	<div class="tab-pane active" id="tab_1">
                                           ...
                                           <tr>
                                                ...
                                                <td><?php echo $getServices->drug_name?></td>
                                                <!-- <td><?php echo $getServices->category?></td> -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            ...
                                            <h4 class="modal-title" id="myModalLabel">Bedside Procedure</h4>
                                        </div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                              <select name="category" onChange="showDrugName(this.value);" id="category" class="form-control input-sm" style="width: 100%;" required>
                                                ...
                                                <?php 
                                                foreach($getServ as $getServ){?>
                                                                              <option value="<?php echo $getServ->cat_id;?>"><?php echo $getServ->med_category_name;?></option>
                                                <?php }?>
                                              </select>
                                              </td>
                                        </tr>
                                            ...
                                            <td>Paricular Item</td>
                                              ...
                                              <!-- <select name="item" id="item" class="form-control input-sm" style="width: 100%;" required>
                                                <option value=" ">- Paricular Item -</option>
                                                  <?php // foreach($getServ as $getServ){?>
                                                  <option value="<?php //echo $getServ->med_category_name;?>"></option>
                                                  <?php// }?>
                                              </select> -->
                                              </span>	
                                              </td>
