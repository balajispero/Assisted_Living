   ...
   <!--  <table class="table">
    ...
    <table class="table table-bordered">
     ...
     echo !empty($nameby_id->cValue) ? $nameby_id->cValue : '' ?>
                ...
                <?php $nameby_id = $ci_obj->general_model->getname($patientInfo->blood_group);
     echo !empty($nameby_id->cValue) ? $nameby_id->cValue : '' ?>
            </td>
        </tr>        
    </table>
    ...
    <table class="table table-bordered">
        ...
        <tr>
            <td><?php echo $patientInfo->ptn_kco;?></td><td><?php echo $patientInfo->ptn_chf_comp;?></td><td><?php echo $patientInfo->ptn_fam_his;?></td><td><?php echo $patientInfo->ptn_past_his;?></td><td><?php echo $patientInfo->ptn_pulse;?></td><td><?php echo $patientInfo->ptn_bp;?></td>
            <td><?php echo $patientInfo->ptn_temp;?></td><td><?php echo $patientInfo->ptn_spo2;?></td><td><?php echo $patientInfo->ptn_um;?></td><td><?php echo $patientInfo->ptn_pa;?></td><td><?php echo $patientInfo->ptn_rs;?></td><td><?php echo $patientInfo->ptn_foodin;?></td>
        </tr>        
    </table>
    <table class="table table-bordered">
        <tr bgcolor="#ddd"><th colspan="2" style="text-align: center">Ongoing Medication</th></tr>
