                            ...
                            <div class="box-footer clearfix">
                            	<div style="margin-top: 15px;">
                                 <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="<?php echo base_url()?>app/ipd/complain/<?php echo $getOPDPatient->IO_ID;?>/<?php echo $getOPDPatient->patient_no;?>"> Complaint</a></li>
                     ...
                     <div class="col-md-9"> 
                                <div class="nav-tabs-custom">
                                	<ul class="nav nav-tabs">
                                		<li class="active"><a href="#tab_1" data-toggle="tab">Mail list</a></li>
                                    ...
                                    <div class="tab-content">
                                    	<div class="tab-pane active" id="tab_1">
                                           ...
                                           <tbody>
                                           <?php foreach($getSentMail as $rows){?>
                                           <tr>
                                           		<td><?php echo $rows->dDate?></td>
                                                <td><?php echo $rows->patient_name?></td>
                                                <td><?php echo $rows->iop_id?></td>
                                                <td><?php echo $rows->mail_to?></td>
                                                 <td><a href="<?php echo base_url()?>app/ipd/sent_mail_view/<?php echo $rows->iop_id?>/<?php echo $getOPDPatient->patient_no?>/<?php echo $rows->mail_id; ?>" >View</a></td> 
                                                <td>
