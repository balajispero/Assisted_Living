                ...
                <section class="content">
                 ...
                 function validate_form(){
					 if(document.getElementById("bed_name").value == ""){
						 	alert("Please select Bed No. to Admit Member.");
						 	return false;
                            ...
                            <div class="box-footer clearfix">
                                ...
                                <div class="form-group">
                                	...
                                	<select name="department" id="department" class="form-control input-sm">
																...
																if($_POST['department'] == $departmentList->patient_type_id){
																	$selected = "selected='selected'";
																}else{
																	$selected = "";
																}
																?>
                                                            	<option value="<?php echo $departmentList->patient_type;?>" <?php echo $selected;?>><?php echo $departmentList->patient_type;?></option>
                                                                <?php }?>
                                                            </select>
                                </div>
