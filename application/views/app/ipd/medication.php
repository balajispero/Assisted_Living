                     ...
                     <div class="col-md-9"> 
                                <div class="nav-tabs-custom">
                                    ...
                                    <div class="tab-pane active" id="tab_1">
                                           ...
                                           <a href="#" class="btn btn-outline-primary add_medication hvr-shutter-in-vertical" data-toggle="modal" data-target="#myModal"><i class="fa fa-plus"></i> Add Medication</a>
                                           <?php }}?>
                                 ...
                                 <input type="hidden" value="<?php echo $med_cnt ?>" name="mm" id="medcnt"> 
                                           ...
                                           <?php if($getOPDPatient->nStatus == "Pending"){?>
                                           <a href="#" class="btn btn-outline-primary hvr-shutter-in-vertical" style="float: right;" data-toggle="modal" data-target="#myModalemerg"><i class="fa fa-plus"></i> Add Emergency Medication</a>
                                           <?php }?>
