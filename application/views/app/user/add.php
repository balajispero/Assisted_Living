                                            ...
                                            <div class="tab-content">
                                            	<div class="tab-pane active" id="tab_1">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <input class="form-control input-sm" name="birthday" id="birthday1" type="date" placeholder="Birthday" style="width:150px;" required>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    	<td>Birth Place</td>
                                                ...
                                                <div class="tab-pane" id="tab_2">
                                                    ...
                                                    <tr>
                                                        <td width="14%" valign="top">Password <font color="#FF0000">*</font></td>
                                                        <td width="86%"> 
                                                        <input type="text" name="password" id="password" class="form-control input-sm" placeholder="Password" style="width: 250px;" required>
                                                        </td>
                                                    </tr>
                                                    </table>
                                                </div>
