        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                     <h1>Member Masterlist Reports</h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url()?>app/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Reports</a></li>
                        <li class="active">Member Masterlist Reports</li>
                    </ol>
                </section>
                 	...
                 	<div class="col-md-6">
                    	 ...
                    	 <div class="box">
                         		...
                         		<div class="box-body table-responsive">
                                    ...
                                    <div class="box-body">
                                            <form method="post" action="<?php echo base_url()?>app/reports/patient_list" onSubmit="return validate();" target="_blank">
                                            ...
                                            <tr>
                                            	<Td><b>Gender</b></Td>
                                                <td>
                                                <select name="gender" id="gender" class="form-control input-sm" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <select name="civil_status" id="civil_status" class="form-control input-sm" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <select name="bloodGroup" id="bloodGroup" class="form-control input-sm" style="width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                <select name="insurance_comp" id="insurance_comp" class="form-control input-sm" style="width: 100%;">
