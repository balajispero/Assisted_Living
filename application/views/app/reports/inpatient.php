        ...
        <div class="wrapper row-offcanvas row-offcanvas-left">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                     <h1>Amitted Member Reports</h1>
                    <ol class="breadcrumb">
                        <li><a href="<?php echo base_url()?>app/dashboard"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="#">Reports</a></li>
                        <li class="active">Amitted Member Reports</li>
                    </ol>
                </section>
                     ...
                     <div class="col-md-6">
                         ...
                         <div class="box">
                                 ...
                                 <div class="box-body table-responsive">
                                    ...
                                    <div class="box-body">
                                            <form method="post" action="<?php echo base_url()?>app/reports/inpatient" onSubmit="return validate();" target="_blank">
