...
<tr>
	<td><strong>Member Name</strong><br /><br /><?php echo strtoupper($patientInfo->patient);?></td>
    <td><strong>Member No.</strong><br /><br /><?php echo strtoupper($patientInfo->patient_no)?></td>
...
<tr>
    ...
    <th width="14%" style="border-bottom:1px #999 solid">Provisional Diagnosis</th>
    <th width="10%" style="border-bottom:1px #999 solid">Complaints</th>
</tr>
<?php foreach($patientvisited as $patientvisited){?>
<tr>
	<td align="center"><?php echo $patientvisited->patient_type?></td>
    <td align="center">
    <?php echo $patientvisited->IO_ID?>
    ...
    <td><?php echo $patientvisited->provisional_diagnosis?></td>
    <td><?php echo $patientvisited->complaints?></td>
</tr>
<?php }?>
</table>
