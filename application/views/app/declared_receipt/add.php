                    	 ...
                    	 <div class="box">
                        	...
                        	<div class="box-body table-responsive">
                                ...
                                <input type="hidden" name="total_purchased" id="total_purchased" value="<?php echo $ORList->total_purchased?>">
                                        ...
                                        <tr>
                                        	<td>Member Type</td>
                                            <td><input readonly value="<?php echo $ORList->patient_type?>" class="form-control input-sm" type="text" placeholder="Member Type" style="width: 250px;" required></td>
                                        </tr>
                                        <tr>
                                        	<td>Patient ID</td>
                                            <td><input readonly value="<?php echo $ORList->patient_no?>" name="patient_no" id="patient_no" class="form-control input-sm" type="text" placeholder="Patient ID" style="width: 250px;" required></td>
                                        </tr>
                                        <tr>
                                        	<td>Member Name</td>
                                            <td><input readonly value="<?php echo $ORList->patient?>" class="form-control input-sm" type="text" placeholder="Member No." style="width: 250px;" required></td>
                                        </tr>
                                        ...
                                        <tr>
                                        	<td>Total Amount</td>
                                            <td><input readonly nkeypress="return isNumberKey(event)" value="<?php echo $ORList->total_amount?>" name="total_amount" id="total_amount" class="form-control input-sm" type="text" placeholder="Member No." style="width: 250px;" required></td>
                                        </tr>
                                        <tr>
                                        	<td colspan="2"><br></td>
                                        </tr>
