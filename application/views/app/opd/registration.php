                 	...
                 	<div class="col-md-12">
                    	 ...
                    	 <div class="box">
                         		...
                         		<div class="box-header">
                                    <h3 class="box-title">Search Member to Masterlist</h3>
                        	...
                        	<div class="box-body table-responsive">
                            	<form role="form" method="post" action="<?php echo base_url()?>app/opd/search_result">
                                		...
                                		<div class="form-group">
                                            ...
                                            <input class="form-control input-sm" name="search" id="search" type="text" placeholder="Member No." style="width: 350px;">
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <button class="btn btn-primary" name="btnSubmit" id="btnSubmit" type="submit"><i class="fa fa-search"></i> Search Member</button>
                                        </div>
                                        <br>
                                </form>
