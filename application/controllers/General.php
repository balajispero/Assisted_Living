...
class general extends CI_Controller{
	...
	public function variable(){
		...
		$this->data['hasAccesstoPatient'] = ($this->has_rights_to_access("49",$userRole->user_role) == FALSE) ? FALSE : TRUE;
			...
			$this->data['hasAccesstoIPDDischarged'] = ($this->has_rights_to_access("136",$userRole->user_role) == FALSE) ? FALSE : TRUE;
		...
		$this->data['hasAccesstoNurse'] = ($this->has_rights_to_access("128",$userRole->user_role) == FALSE) ? FALSE : TRUE;
			...
			$this->data['hasAccesstoNurseDrugChart'] = ($this->has_rights_to_access("135",$userRole->user_role) == FALSE) ? FALSE : TRUE;
		...
		$this->data['hasAccesstoPreasses'] = ($this->has_rights_to_access("139",$userRole->user_role) == FALSE) ? FALSE : TRUE;
			$this->data['hasAccesstoPreassesList'] = ($this->has_rights_to_access("140",$userRole->user_role) == FALSE) ? FALSE : TRUE;		
		...
		$this->data['hasAccesstoReport'] = ($this->has_rights_to_access("132",$userRole->user_role) == FALSE) ? FALSE : TRUE;
			...
			$this->data['hasAccesstoDashboard'] = ($this->has_rights_to_access("149",$userRole->user_role) == FALSE) ? FALSE : TRUE;
	...
	public function ipdLists($val = NULL){
		...
		// print_r($this->data['showPatients']);die;
