...
class Appointment extends General{
	...
	public function addAppointmentList($offset = 0){
		...
		$config['base_url'] = base_url().'appappointment/addAppointmentList/';
		...
		$this->table->set_heading('Member No', 'Member Name','Action');
		$i = 0 + $offset;
	...
	public function patient_master($offset = 0){
		...
		$config['base_url'] = base_url().'appappointment/index/';
        ...
        $this->table->set_template($tmpl);
		$this->table->set_empty("&nbsp;");
		$this->table->set_heading('Member No', 'Member Name','Date Appointment','Consultant Doctor','Status','Date Visited','Action');
		$i = 0 + $offset;
	...
	public function checkInApp($id){
		...
		$value = $id;
		General::logfile('Member Appointment','CHECK IN',$value);
				
		$this->session->set_flashdata('message',"<div class='alert alert-success alert-dismissable'><i class='fa fa-check'></i><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>Member Appointment successfully Checked IN!</div>");
	...
	public function delete($id){
		...
		$value = $id;
		General::logfile('Member Appointment','DELETED',$value);
				
		$this->session->set_flashdata('message',"<div class='alert alert-success alert-dismissable'><i class='fa fa-check'></i><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>Member Appointment successfully Deleted!</div>");
			
		//redirect
		redirect(base_url().'appappointment',$this->data);
	}
	...
	public function save(){
		$this->form_validation->set_rules("patientID","Member No.","trim|xss_clean|required");
	...
	public function editAppointmentSave(){
		$this->form_validation->set_rules("id","Member No.","trim|xss_clean|required");
		...
		if($this->form_validation->run()){
			...
			$this->session->set_flashdata('message',"<div class='alert alert-success alert-dismissable'><i class='fa fa-check'></i><button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>Member Appointment successfully Updated!</div>");
	...
	public function edit_save(){
		...
		if($this->form_validation->run()){
			...
			//logfile
			$value = $this->input->post('firstname')." ".$this->input->post('middlename')." ".$this->input->post('lastname');
			General::logfile('Member Management','UPDATE',$value);
