...
class Opd extends General{
	...
	public function index($offset = 0){
        ...
        $this->table->set_template($tmpl);
		$this->table->set_empty("&nbsp;");
		$this->table->set_heading('OPD No','Member No','Member Name','Age','Visit Date Time','Department','Consultant Doctor','Status','');
		$i = 0 + $offset;
	...
	public function save_opd(){
		$this->form_validation->set_rules("patient_no","Member No.","trim|xss_clean|required|callback_validate_opd");
	...
	public function getDrugName($id){
		// print_r($id);die;
		$this->data['drugnamelists'] = $this->opd_model->listservices($id);	
		// print_r($this->data['drugnamelists']);die;
	...
	public function laboratory(){
		...
		//list of category
		$this->data['particular_cat'] = $this->billing_model->particular_cat();
		$this->data['infolab'] = $this->opd_model->patient_lab($iop_no);
		
		$this->data['patient_lab'] = $this->opd_model->patient_lab($iop_no);
		
		// print_r($this->data['infolab']);die;
