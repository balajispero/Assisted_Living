...
class Reports extends General{
	...
	public function patient_list(){
		if(isset($_POST['btnView'])){
			...
			$this->data['reports_title'] = "Member Masterlist Reports";
	...
	public function outpatient(){
		if(isset($_POST['btnView'])){
			...
			$this->data['reports_title'] = "Out Member Reports";
    ...
    public function inpatient(){
        if(isset($_POST['btnView'])){
			...
			$this->data['reports_title'] = "Admitted Member Reports";
	...
	public function discharged_patient(){
		if(isset($_POST['btnView'])){
			...
			$this->data['reports_title'] = "Discharged Member Reports";
