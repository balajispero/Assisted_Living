...
class Ipd_print extends General{
	...
	public function print_medication(){
		...
		$this->data['reports_title'] = "Member Medication Reports";
	...
	public function print_drug_chart(){
		$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
		
			$this->data['getOPDPatient'] = $this->opd_model->getOPDPatient($iop_no);
			$this->data['getNurseProgressNote'] = $this->opd_model->getDrugChart($iop_no);
			$this->data['patientInfo'] = $this->patient_model->getPatientInfo($patient_no);	
			
			$this->data['reports_title'] = "Patient Drug Reports";
			$this->load->view("app/ipd_reports/print_drug_chart",$this->data);	
	}
	...
	public function print_individual_care_plan(){
		$iop_no = $this->uri->segment("4");
			$patient_no = $this->uri->segment("5");
			...
			$this->data['reports_title'] = "Patient Individual Care Plan Reports";
			$this->load->view("app/ipd_reports/print_individual_care_plan",$this->data);	
	}
	...
	public function print_discharge_summary(){
		...
		$this->data['reports_title'] = "Member Discharge Summary Reports";
