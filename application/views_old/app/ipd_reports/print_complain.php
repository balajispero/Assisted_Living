...
<tr style="border-bottom:1px #999 solid">
	...
	<th style="border-bottom:1px #999 solid">Complain Name</th>
	<th style="border-bottom:1px #999 solid">Remarks</th>
</tr>
<?php foreach($patientComplain as $patientComplain){?>
                                           <tr>
                                           		<td><?php echo date("M d, Y",strtotime($patientComplain->dDate));?></td>	
