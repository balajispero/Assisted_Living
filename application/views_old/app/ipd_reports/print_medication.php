...
<tr style="border-bottom:1px #999 solid">
	<th style="border-bottom:1px #999 solid">Date</th>
     <th style="border-bottom:1px #999 solid">Medicine Name</th>
     <th style="border-bottom:1px #999 solid">From Date</th>
     <th style="border-bottom:1px #999 solid">To Date</th>
     <th style="border-bottom:1px #999 solid">Dose</th>
     <th style="border-bottom:1px #999 solid">Qty</th>
     <th style="border-bottom:1px #999 solid">Prepared by</th>
</tr>
<?php foreach($patient_Medication as $rows){?>
<tr>
												<td><?php echo date("M d, Y h:i:s A",strtotime($rows->added_date));?></td>
