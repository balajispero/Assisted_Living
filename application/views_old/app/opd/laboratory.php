...
(adsbygoogle = window.adsbygoogle || []).push({});
    ...
    <body class="skin-blue">
            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url()?>app/doctor/ipd">Out-Member Master</a></li>
                            ...
                            <div class="box-footer clearfix">
                            	<div style="margin-top: 15px;">
                                 <ul class="nav nav-pills nav-stacked">
                                    ...
                                    <li class="active"><a href="<?php echo base_url()?>app/opd/laboratory/<?php echo $getOPDPatient->IO_ID;?>/<?php echo $getOPDPatient->patient_no;?>"> Laboratory</a></li>
                                    ...
                                    <div class="tab-content">
                                    	<div class="tab-pane active" id="tab_1">
                                           ...
                                           <tr>
                                                ...
                                                <?php if($this->session->userdata('emr_viewing') == ""){?>	
                                                <?php if($getOPDPatient->nStatus == "Pending"){?>
                                                <a href="<?php echo base_url()?>app/opd/delete_lab/<?php echo $patient_lab->io_lab_id?>/<?php echo $getOPDPatient->IO_ID?>/<?php echo $getOPDPatient->patient_no?>" onClick="return confirm('Are you sure you want to remove?');">Remove</a>
                                                <?php }}?>
                                                </td>
                                           </tr>
                                           <?php }?>
        ...
        <!-- Modal -->
                            <form method="post" action="<?php echo base_url()?>app/opd/save_laboratory" onSubmit="return confirm('Are you sure you want to save?');">
