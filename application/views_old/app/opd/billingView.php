            ...
            <aside class="right-side">                
                ...
                <section class="content-header">
                   ...
                   <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url()?>app/opd/index">Out-Member Master</a></li>
                     ...
                     <div class="col-md-9"> 
                                    	...
                                    	<div class="tab-pane" id="tab_2">
                                               ...
                                               <div class="form-group">
                                            		<label for="exampleInputEmail1">Date</label>
                                            		 <input type="text" value="<?php echo date("M d, Y", strtotime($headerInv->dDate));?>" name="invoiceno" id="invoiceno" class="form-control input-sm" style="width:250px;" readonly>
                                        		</div>
                                               
                                                <div class="form-group">
                                            		<label for="exampleInputEmail1">Invoice No.</label>
                                            		 <input type="text" value="<?php echo $headerInv->invoice_no?>" name="invoiceno" id="invoiceno" class="form-control input-sm" style="width:250px;" readonly>
                                                ...
                                                <div class="form-group">
                                            		...
                                            		<select name="paymentType" id="paymentType" class="form-control input-sm" style="width:250px;" onChange="setTitle(this.value)">
                                                        ...
                                                        <option value="cash" <?php if($headerInv->payment_type == "cash"){ echo "selected";}?>>Cash</option>
                                                        <option value="credit" <?php if($headerInv->payment_type == "credit"){ echo "selected";}?>>Credit</option>
                                                        <option value="insurance" <?php if($headerInv->payment_type == "insurance"){ echo "selected";}?>>Insurance Company</option>
                                                    </select>
                                        		</div>
                                               
                                               <div class="form-group" id="credit" style=" display:none;">
                                            		<label for="exampleInputEmail1">Credit Card No.</label>
                                            		 <input type="text" value="<?php echo $headerInv->creditCardNo?>" placeholder="Credit Card No." name="creditCardNo" id="creditCardNo" class="form-control input-sm" style="width:250px;">
                                        		</div>
                                                ...
                                                <div class="form-group" id="insurance" style=" display:none;">
                                            		...
                                            		<select name="insurance_company" id="insurance_company" class="form-control input-sm" style="width:250px;">
                                                        ...
                                                        <?php 
														foreach($insurance_company as $insurance_company){
														if($insurance_company->in_com_id == $headerInv->insurance_company){
															$selected = "selected";	
														}else{
															$selected = "";	
														}
														?>
                                                        <option value="<?php echo $insurance_company->in_com_id;?>" <?php echo $selected?>><?php echo $insurance_company->company_name;?></option>
                                                        <?php }?>
                                                    </select>
                                        		</div>
                                                ...
                                                <div class="form-group" id="credit">
                                            		...
                                            		<textarea placeholder="Remarks" class="form-control input-sm" style="width:60%; height:100px;" name="remarks" id="remarks"><?php echo $headerInv->remarks?></textarea>
                                        		</div>
                                        ...
                                        <div class="tab-pane active" id="tab_1">
                                           ...
                                           <div class="alt2" dir="ltr" style="
                                    		...
                                    		<tbody>
												...
												?>
                                            	<tr>
                                                	<td><input type="text" size="7" style="width:98%; background-color:#F9F9f9; border:1px solid #ccc; text-align:right" name="id<?php echo $num;?>" id="id<?php echo $num;?>" value="<?php echo $num;?>. " readonly="true"></td>
                                            ...
                                            <input type="hidden" name="hdnrowcnt" id="hdnrowcnt" value="<?php echo $num;?>">
                                    		</div>
                            ...
                            <div class="box-footer clearfix">
                                ...
                                <tr>
                                    ...
                                    <a href="<?php echo base_url()?>app/opd/printInv/<?php echo $getOPDPatient->IO_ID?>/<?php echo $patientInfo->patient_no?>/<?php echo $headerInv->invoice_no?>" class="btn btn-default"> <i class="fa fa-print"></i> Print</a>
                                    </td>
                                    <td align="right">GROSS&nbsp;&nbsp;
                                    <input type="text" name="nGross" id="nGross" readonly style="width:100px;" value="<?php echo $headerInv->total_amount?>"></td>
                                </tr>
                                </table>
                            </div>
                        </div>
