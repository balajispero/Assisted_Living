...
<div class="row">
	...
	<table width="100%" border="0">
		...
		<tr>
			...
			<!--		<h3>Watch Demo Assisted Living</h3><br>-->
			<!--		<center><iframe width="560" height="315" src="https://www.youtube.com/embed/RiPYOC7o1sg?autoplay=1" frameborder="0" allowfullscreen></iframe></center>-->
			<!--		<br>-->
			<!--		For more information and inquiry feel free to contact me<br>-->
			<!--		Email address: jasonsarino27@gmail.com<br>-->
			<!--		Webdite: <a href="http://www.jaysonsarino.com" target="_blank">www.jaysonsarino.com</a><br>-->
			<!--		Skype: jasonsarino27<br><br><br><br><br>-->
			<!--	</div>-->
